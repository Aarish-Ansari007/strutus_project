						...
						<input type="text" class="search-query" placeholder="Search by name and No">						
                                    ...
                                    <div class="col-md-2 col-sm-12">            
											<a class="btn btn-default btn-select mrgn-botm">
												...
												<ul>
													<li class="selected">Select category</li>
													<li>Buyer</li>									
													<li>Supplier</li>								
					...
					<div class="col-md-2 col-sm-12">
					 ...
					 <div class="col-md-12 listings">
										...
										<div class="col-md-2 col-sm-12">            
										 ...
										 <a href="bar-add-vendor.html" class="btn btn-primary btn-flat btn-pri pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Vendor</a>
												...
												<tbody>
												  <tr>
													...
													<td><span class="bt-content"><a href="bar-view-vendor.html">John Doe</a></span></td>
													<td><span class="bt-content">Bar</span></td>
													<td data-th="Qty in Stock">
													<span class="bt-content">Johndoe@gmail.com</span>
													</td>												
													<td><span class="bt-content">0987654321</span></td>
													<td><span class="bt-content">Rs 10,000</span></td>
													<td class="font-st">											
													<a class="delets" data-toggle="modal" data-target="#delet" href="#"><i class="fa fa-trash-o" aria-hidden="true"></i>
													</a>
													<a class="delets" href="bar-view-vendor.html"><i class="fa fa-eye" aria-hidden="true"></i>
													</a>
                                                 <a class="delets" href="bar-vendor-profile.html"> 
