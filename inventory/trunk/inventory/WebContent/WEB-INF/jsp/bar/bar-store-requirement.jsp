...
<html lang="zxx">
<head>
<title>Store Requirements</title>
<!-- custom-theme -->
					...
					<form class="filter-drop-down">
										...
										<div class="input-daterange input-group">
                                          ...
                                          <div class="col-md-2 col-sm-12">            
											<a class="btn btn-default btn-select">
												...
												<span class='btn-select-arrow glyphicon glyphicon-chevron-down'></span>
												<ul>
													<li class="selected">Select Status</li>
													<li>Done</li>								
													<li>Requested</li>                                                    
												</ul>
											</a>
					 ...
					 <div class="col-md-12 listings">
										...
										<div class="col-md-2 col-sm-12 pull-right">            
                                           ...
                                           <div class="col-md-3 col-sm-12 pull-right text-right">
											 ...
											 <button type="button" class="btn btn-danger">Edit</button>						 
												...
												<tbody>
												 ...
												 <tr>
													...
													<td><span class="bt-content">4 Bottle</span></td>
												</tr>
