...
<form id="inventoryBarProductForm" method="post" name="inventoryBarProductForm" action="">
<!-- banner -->
                     ...
                     <!-- /filter-->
					  <div class="col-md-12 listings">
										...
										<div class="col-md-2 col-sm-12">            
										 ...
										 <a href="bar-store-add-product.html" class="btn btn-primary btn-flat btn-pri pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Product</a>
												...
												<tbody>
												  <tr>
													...
													<td><span class="bt-content">15-9-2017</span></td>
													<td data-th="Qty in Stock">
													<span class="bt-content">15 bottle</span>
													</td>
													<td>
													<span class="bt-content">John Doe</span>
													</td>
                                                     <td>
													<span class="bt-content">200 bottle</span>
													</td>													
													<td>													
													<span class="bt-content">													
													<a class="delets btn-danger btn" data-toggle="modal" data-target="#delet"  href="#"><i class="fa fa-trash-o" aria-hidden="true"></i>
													</a>
													<a class="delets btn-primary btn" href="bar-edit-product.html"><i class="fa fa-pencil" aria-hidden="true"></i>
													</a>
													</span>
													</td>													
												</tr>
