			...
			<div class="w3l_agileits_breadcrumbs">
				...
				<div class="col-md-12 listings">
					            <div class="w3l-table-info agile_info_shadow mrgn-tops">
										 <h3 class="w3_inner_tittle two pull-left">Bar Edit Product</h3>
								                <div class="form-body">
												<form>
													<div class="col-md-6">
													       ...
													       <div class="form-group">
                                                            ...
                                                            <div class="form-group">
																...
																<div class="form-group">
                                                                <label class="col-md-12 control-label">Total Bottels
                                                                </label>
                                                                <div class="col-md-8">
													...
													<div class="col-md-6">
                                                           <div class="form-group">
															...
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Amount Paid:</label>
                                                                <div class="col-md-6">
                                                                    <input class="form-control" name="" placeholder="" type="text">
																</div>
																<div class="col-md-6">            
