...
<div class="wthree_agile_admin_info">
		...
		<div class="inner_content">		
			...
			<div class="w3l_agileits_breadcrumbs">
                ...
                <html:hidden property="ID" name="tempKitchenFormVO"/>     					
				<div class="col-md-12 listings">
					            <div class="w3l-table-info agile_info_shadow mrgn-tops">
										 <h3 class="w3_inner_tittle two pull-left">Edit Profile</h3>
								                <div class="form-body">
												<form>
													<div class="col-md-6">
														 <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <!-- input class="form-control" name="tempKitchenFormVO" placeholder="" id="name" value="" type="text"-->
                                                                    <!-- bean:write name="tempKitchenFormVO" property="name"/-->
                                                                    <html:text property="name" styleId="name" maxlength="35" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
                                                            <div class="form-group">
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="phoneNo" value="" type="text"> -->
                                                                    <html:text property="phoneNo" styleId="phoneNo" maxlength="10" size="63" styleClass="textBox" name="tempKitchenFormVO"/>                                                                    
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Email Id: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="emailId" value="" type="text"> -->
                                                                    <html:text property="emailId" styleId="emailId" maxlength="256" size="63" styleClass="textBox" name="tempKitchenFormVO"/>                                                                                                                                     
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Tin: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="tin" value="" type="text"> -->
                                                                    <html:text property="tin" styleId="tin" maxlength="11" size="63" styleClass="textBox" name="tempKitchenFormVO"/>                                                                                                                                                                                                        
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Vat: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="vatNo" value="" type="text"> -->
                                                                    <html:text property="vatNo" styleId="vatNo" maxlength="9" size="63" styleClass="textBox" name="tempKitchenFormVO"/>                                                                                                                                                                                                                                                                          
																</div>
                                                            </div>															
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Pan Card: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="pan" value="" type="text"> -->
                                                                     <html:text property="pan" styleId="pan" maxlength="10" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Gst In: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="gst" value="" type="text"> -->
                                                                    <html:text property="gst" styleId="gst" maxlength="15" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Service Tax No: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="serviceTaxNo" value="" type="text"> -->
                                                                    <html:text property="serviceTaxNo" styleId="serviceTaxNo" maxlength="15" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Contact Person: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder=""  id="contactPerson" value="" type="text"> -->
                                                                    <html:text property="contactPerson" styleId="contactPerson" maxlength="50" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Contact Phone: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="contactPhone" value="" type="text"> -->
                                                                     <html:text property="contactPhone" styleId="contactPhone" maxlength="10" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Contact Email: </label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="contactEmail" value="" type="text"> -->
                                                                    <html:text property="contactEmail" styleId="contactEmail" maxlength="10" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                            </div>
													...
													<div class="col-md-6">		
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="billingAddress" value="" type="text"> -->
                                                                    <html:text property="billingAddress" styleId="billingAddress" maxlength="150" size="63" styleClass="textBox" name="tempKitchenFormVO" onblur="setShippingAddress();"/>
																</div>
                                                             </div>
														    <div class="form-group">
															 ...
															 <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="billingCityId" value="" type="text"> -->
                                                                    <html:text property="billingCityId" styleId="billingCityId" maxlength="20" size="63" styleClass="textBox" name="tempKitchenFormVO" onblur="setShippingAddressCity();"/>
																</div>
                                                             </div>
															  <div class="form-group">
                                                                <label class="col-md-12 control-label">Pincode:</label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="billingPinCode" value="" type="text"> -->
                                                                    <html:text property="billingPinCode" styleId="billingPinCode" maxlength="6" size="63" styleClass="textBox" name="tempKitchenFormVO" onblur="setShippingAddressPIN();"/>
																</div>
                                                             </div>
															</div>
															...
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Address:</label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="shippingAddress" value="" type="text"> -->
                                                                    <html:text property="shippingAddress" readonly="" styleId="shippingAddress" maxlength="150" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                             </div>
														    <div class="form-group">
                                                                <label class="col-md-12 control-label">Country:</label>
                                                                <div class="col-md-12">            
																		<html:select property="shippingCountryId" styleId="shippingCountryId" styleClass="selectBoxTag" onchange="stateListEnableForShipping();" style="width:125px" name="tempKitchenFormVO">
																			<html:option value="0">----SELECT----</html:option>
															 ...
															 <div class="form-group">
                                                                <label class="col-md-12 control-label">State:</label>
                                                                <div class="col-md-12">            
 																	    <html:select property="shippingStateId" styleId="shippingStateId" styleClass="selectBoxTag" style="width:125px" name="tempKitchenFormVO">
																			<html:option value="0">----SELECT----</html:option>
															 ...
															 <div class="form-group">
                                                                <label class="col-md-12 control-label">City:</label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="shippingCityId" value="" type="text"> -->
																    <html:text property="shippingCityId" styleId="shippingCityId" readonly="" maxlength="20" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
															  ...
															  <div class="form-group">
                                                                <label class="col-md-12 control-label">Pincode:</label>
                                                                <div class="col-md-12">
                                                                    <!-- <input class="form-control" name="tempKitchenFormDetail" placeholder="" id="shippingPinCode" value="" type="text"> -->
                                                                    <html:text property="shippingPinCode" styleId="shippingPinCode" readonly="" maxlength="6" size="63" styleClass="textBox" name="tempKitchenFormVO"/>
																</div>
                                                             </div>
															</div>
															<script type="application/x-javascript"> 
															...
															function saveKitchenVandorDetails(){
																...
																var status = window.confirm("Do you wish to save kitchen vendor details ?");
																if(status){						
