...
<script type="application/x-javascript"> 
		...
		function totalCount(){			
			...
			var quantity = document.getElementById("quantityId").options[document.getElementById("quantityId").selectedIndex].text;
		...
		function totalAmoundPending(){			
			...
			var amountPaidTypeId = document.getElementById("amountPaidTypeId").options[document.getElementById("amountPaidTypeId").selectedIndex].text;
			var pendingAmount = temp +" "+amountPaidTypeId;
		...
		<div class="inner_content">		
			...
			<div class="w3l_agileits_breadcrumbs">
					...
					<bean:define id="tempProductFormVO" name="ProductFormVO" type="com.indianmesh.inventory.kitchen.product.ProductFormVO"></bean:define>                              										
               		...
               		<html:hidden property="ID" name="tempProductFormVO"/> 
					 ...
					 <div class="col-md-12 listings">
					            <div class="w3l-table-info agile_info_shadow mrgn-tops">
										 <h3 class="w3_inner_tittle two pull-left">Edit Product</h3>
								                <div class="form-body">
												<form>																																	               										 
													<div class="col-md-6">	
														    <html:hidden property="productId" name="tempProductFormVO"/>
													       ...
													       <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <html:text property="name" styleId="name" maxlength="20" size="63" styleClass="textBox" name="tempProductFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <html:text property="description" styleId="description" maxlength="256" size="63" styleClass="textBox" name="tempProductFormVO"/>
                                                                </div>
                                                            </div>															 
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
																  <html:text property="quantityPerItem" styleId="quantityPerItem" maxlength="6" size="33" styleClass="textBox" onblur="totalCount();" name="tempProductFormVO"/>
																</div>															
																<div class="col-md-6">            
																	<html:select property="quantityId" styleId="quantityId" styleClass="selectBoxTag" style="width:125px" onchange="totalCount();" name="tempProductFormVO">
																		<html:option value="0">----SELECT----</html:option>
																...
																Qty Count:
																  ...
																  <html:text property="quantityCount" styleId="quantityCount" maxlength="3" size="63" styleClass="textBox" onblur="totalCount();" name="tempProductFormVO"/>
																  </div>
																</div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <html:text property="total" styleId="total" maxlength="26" size="63" readonly="" styleClass="textBox" name="tempProductFormVO"/>
                                                                </div>
                                                            </div>																                                                           
												    </div>
													<div class="col-md-6">                                                        
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <html:text property="costPrice" styleId="costPrice" maxlength="6" size="63" styleClass="textBox" name="tempProductFormVO" onblur="totalAmoundPending();"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-6 control-label">Amount Paid:</label>
                                                                 <label class="col-md-6 control-label">Paid Type: </label>
                                                                <div class="col-md-6">
                                                                    <html:text property="amountPaid" styleId="amountPaid" maxlength="6" size="33" styleClass="textBox" onblur="totalAmoundPending();" name="tempProductFormVO"/>
																</div>
																<div class="col-md-6"> 
																<script type="application/x-javascript">
			                                                                function totalAmoundPending(){	
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <html:text property="pendingAmount" styleId="pendingAmount" maxlength="26" size="63" styleClass="textBox" readonly="" name="tempProductFormVO"/>
																</div>
                                                            </div>
															<div class="form-group">
                                                                <label class="col-md-12 control-label">Credit Notes:</label>
                                                                <div class="col-md-12">
                                                                    <textarea class="form-control" id="creditNote" maxlength="256" name="creditNote" name="tempProductFormVO"><bean:write name='tempProductFormVO' property='creditNote' /></textarea>
																</div>
                                                            </div>
															...
															function updateProductForm(){																
																...
																if(document.getElementById('name').value.length > 20){  
															         alert("Product Name should not greater than 20 characters long.");
																         alert("Product Name should not be contain only Special Characters or only Digits.");
																         document.getElementById('name').value=''; 
																         document.getElementById("name").focus();
																         return;
																    }
																...
																var status = window.confirm("Do you wish to update product registration details ?");
															...
															<div class="form-group">
																<div class="col-md-12">
																 	<button type="button" class="btn btn-primary" onclick="updateProductForm();">Update</button>
