												...
												<form>
													...
													<div class="col-md-6">												
													       <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
																	<bean:write name="formVOO" property="name" />
																</div>
                                                            </div>															
                                                            <div class="form-group">
                                                                <label class="col-md-12 control-label">Product Type: </label>
	                                                                <div class="col-md-12">            																																	
																		<bean:write name="formVOO" property="productTypeId" />
																	</div>																
                                                            </div>  
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12">
                                                                	<bean:write name="formVOO" property="description" />
                                                                </div>
                                                            </div>																																															                                                           
												    </div>
													...
													<div class="form-group">
                                                          ...
                                                          <div class="col-md-12">            
	                                                            <div class="col-md-6">                                                            
																	<bean:write name="formVOO" property="quantityId" />
																</div>																	  
																<div class="col-md-6">            																	
																	<bean:write name="formVOO" property="quantityTypeId" />
																</div>															 
															</div>
													 </div>
