...
public class IngredientProductFormVO implements Serializable {
	...
	public IngredientProductFormVO() {
		super();
	}

	public IngredientProductFormVO(String productId, String ingredientProductId, String ingredientProductQuantity,
	...
	public int hashCode() {
		...
		result = prime * result + ((ingredientProductQuantity == null) ? 0 : ingredientProductQuantity.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IngredientProductFormVO other = (IngredientProductFormVO) obj;
	...
	public String toString() {
		return "IngredientProductFormVO [productId=" + productId + ", ingredientProductId=" + ingredientProductId
				+ ", ingredientProductQuantity=" + ingredientProductQuantity + ", ingredientProductQuantityTypeId="
				+ ingredientProductQuantityTypeId + ", inventoryProductId=" + inventoryProductId + ", pageFrom="
				+ pageFrom + ", pageTo=" + pageTo + ", limit=" + limit + ", length=" + length + ", length=" + length +"]";
	}
