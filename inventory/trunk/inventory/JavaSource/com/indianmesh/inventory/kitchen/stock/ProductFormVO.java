...
public class ProductFormVO implements Serializable{
	...
	public ProductFormVO(String storeId, String stockId, String sellerId, String subSellerId, String productId, String productName,
			String vendorId, String vendorName, String availableId, String consumptionId, String requirementId,
			String additionId, String creditnoteId, String status, String statusOn, String statusOff,
			String createdDate, String lastModifiedDate, String pageFrom, String pageTo, String limit, String length,
			String fromDate, String toDate, String quantityTypeId, String lastCount, String quantityPerUnit, 
			String supplyDate, String requestDate, String price, String reminder, String ID) {
		super();
	...
	public String toString() {
		return "ProductFormVO [stockId=" + stockId + ", sellerId=" + sellerId + ", subSellerId=" + subSellerId
				+ ", productId=" + productId + ", productName=" + productName + ", vendorId=" + vendorId
				+ ", vendorName=" + vendorName + ", availableId=" + availableId + ", consumptionId=" + consumptionId
				+ ", requirementId=" + requirementId + ", additionId=" + additionId + ", creditnoteId=" + creditnoteId
				+ ", status=" + status + ", statusOn=" + statusOn + ", statusOff=" + statusOff + ", createdDate="
				+ createdDate + ", lastModifiedDate=" + lastModifiedDate + ", pageFrom=" + pageFrom + ", pageTo="
				+ pageTo + ", limit=" + limit + ", length=" + length + ", fromDate=" + fromDate + ", toDate=" + toDate 
				+ ", storeId=" + storeId + ", quantityTypeId=" + quantityTypeId + ", supplyDate=" + supplyDate
				+ ", lastCount=" + lastCount + ", quantityPerUnit=" + quantityPerUnit + ", requestDate=" + requestDate
				+ ", price=" + price + ", ID=" + ID + ", reminder=" + reminder + "]";
	}
