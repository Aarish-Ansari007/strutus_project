...
public class ProductFormVO implements Serializable{
		...
		private String quantityTypeOfTotal = null;
		
		private String transactionId = null;
		private String invoiceId = null;
		private String filePathOfInvoice = null;
		...
		public ProductFormVO(String productId, String sellerId, String subSellerId, String name, String productType,
				String description, String quantityId, String quantityPerItem, String quantityCount, String consumed,
				String required, String status, String total, String vendorId, String costPrice, String amountPaid,
				String amountPaidTypeId, String pendingAmount, String creditNote, String createdDate,
				String lastModifiedDate, String transactionId, String invoiceId, String filePathOfInvoice,
				String pageFrom, String pageTo, String limit, String length, String fromDate, String toDate, String quantityTypeOfTotal, String ID) {
			super();
			...
			this.filePathOfInvoice = filePathOfInvoice;
			...
			this.toDate = toDate;
			this.quantityTypeOfTotal=quantityTypeOfTotal;
			this.ID=ID;
		}
		...
		public int hashCode() {
			...
			result = prime * result + ((filePathOfInvoice == null) ? 0 : filePathOfInvoice.hashCode());
			...
			result = prime * result + ((quantityTypeOfTotal == null) ? 0 : quantityTypeOfTotal.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (amountPaidTypeId == null) {
				...
				return false;
			if (quantityTypeOfTotal == null) {
				if (other.quantityTypeOfTotal != null)
					return false;
			} else if (!quantityTypeOfTotal.equals(other.quantityTypeOfTotal))
				return false;
			if (consumed == null) {
			...
			if (description == null) {
				...
				return false;
			if (filePathOfInvoice == null) {
				if (other.filePathOfInvoice != null)
					return false;
			} else if (!filePathOfInvoice.equals(other.filePathOfInvoice))
				return false;
			if (fromDate == null) {
		...
		public String toString() {
			return "ProductFormVO [productId=" + productId + ", sellerId=" + sellerId + ", subSellerId=" + subSellerId
					...
					+ lastModifiedDate + ", transactionId=" + transactionId + ", invoiceId=" + invoiceId
					+ ", filePathOfInvoice=" + filePathOfInvoice + ", pageFrom=" + pageFrom + ", pageTo=" + pageTo
					+ ", limit=" + limit + ", length=" + length + ", fromDate=" + fromDate + ", toDate=" + toDate 
					+ ", ID=" + ID + ", quantityTypeOfTotal=" + quantityTypeOfTotal + "]";
		}
		...
		public String getFilePathOfInvoice() {
			return filePathOfInvoice;
		}

		public void setFilePathOfInvoice(String filePathOfInvoice) {
			this.filePathOfInvoice = filePathOfInvoice;
		}

		public String getQuantityTypeOfTotal() {
			return quantityTypeOfTotal;
		}

		public void setQuantityTypeOfTotal(String quantityTypeOfTotal) {
			this.quantityTypeOfTotal = quantityTypeOfTotal;
		}
