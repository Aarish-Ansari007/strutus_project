...
public class ProductForm extends ActionForm {
		...
		public ProductForm(String productId, String sellerId, String subsellerId, String name, String productTypeId,
				...
				List<String> inventoryProductQuantityTypeList, String pageFrom, String pageTo, String limit,
				String length, String fromDate, String toDate, String iD, String transactionId, String invoiceId,
				String filePathOfInvoice) {
			super();
		...
		public String toString() {
			return "ProductForm [productId=" + productId + ", sellerId=" + sellerId + ", subsellerId=" + subsellerId
					...
					+ pageFrom + ", pageTo=" + pageTo + ", limit=" + limit + ", length=" + length + ", fromDate="
					+ fromDate + ", toDate=" + toDate + ", ID=" + ID + ", transactionId=" + transactionId
					+ ", invoiceId=" + invoiceId + ", filePathOfInvoice=" + filePathOfInvoice + "]";
		}
