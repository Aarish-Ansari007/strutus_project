...
public class ProductForm extends ActionForm {
			...
			public ProductForm(String productId, String sellerId, String subSellerId, String name, String productType,
					...
					String createdDate, String lastModifiedDate, String transactionId, String invoiceId,
					String filePathOfInvoice, String pageFrom, String pageTo, String limit, String length,
					String fromDate, String toDate, String quantityTypeOfTotal, String ID) {
				super();
			...
			public String toString() {
				return "ProductForm [productId=" + productId + ", sellerId=" + sellerId + ", subSellerId=" + subSellerId
						...
						+ ", limit=" + limit + ", length=" + length + ", fromDate=" + fromDate + ", toDate=" + toDate + ", quantityTypeOfTotal=" + quantityTypeOfTotal
						+ ", ID=" + ID + "]";
			}
